...
/**
 * Resolve acode-specific path patterns for sandbox-runtime.
 *
 * acode uses special path prefixes in permission rules:
...
/**
 * Convert acode settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where acode started)
