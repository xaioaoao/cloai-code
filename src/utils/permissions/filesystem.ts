...
// Always ask when acode tries to edit its own config files
 ...
 * This is a per-user temporary directory used by acode for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by acode)
