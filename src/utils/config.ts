...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when acode was first started on this machine
  ...
  // acode usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first acode OAuth token
  ...
  // acode hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
